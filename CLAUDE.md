...
Current active checkpoint:
  CLIMATE / WEATHER / REGIONAL SEASONALITY FOUNDATION-1 (roadmap item 2 —
  foundational, before seasonal-route migration). EXPEDITIONARY LOGISTICAL
...
2. **CLIMATE / WEATHER / SEASONAL VARIABILITY-1 — FOUNDATIONAL.** ← **ACTIVE.** *Promoted 2026-07-16* to sit immediately after expeditionary logistics and **before** seasonal migration.
